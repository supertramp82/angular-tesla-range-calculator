...
@Component({
  ...
  template: `
    <form class="tesla-battery" [formGroup]="tesla">
      ...
      <div class="tesla cf" formGroupName="config">
        <app-tesla-counter
            [title]="'Speed'"
            [unit]="'mph'"
            [step]="5"
            [min]="45"
            [max]="70"
            formControlName="speed"></app-tesla-counter>
        <div class="tesla-climate cf">
            <app-tesla-counter
                ...
                [min]="-10"
                [max]="40"
                formControlName="temperature"></app-tesla-counter>
            <app-tesla-climate
...
export class TeslaBatteryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.stats = this.calculateStats(
      this.results,
      this.tesla.controls['config'].value
    );
